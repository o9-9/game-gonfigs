...
Get-FileFromWeb -URL "https://github.com/FR33THYFR33THY/Github-Game-Configs/raw/refs/heads/main/Battlefield/Battlefield%20Hardline.zip" -File "$env:SystemRoot\Temp\Battlefield Hardline.zip"
Clear-Host
